...
MIDL_DEFINE_GUID(IID, LIBID_MgaComponentLib,0xA3E45300,0x3B12,0x4243,0xAD,0x1D,0x7C,0xB8,0x67,0xF9,0xFA,0xF2);


MIDL_DEFINE_GUID(CLSID, CLSID_MgaComponent,0x663A3D7A,0xF747,0x4980,0x96,0x0F,0x20,0xF2,0x1C,0x65,0x55,0x1B);
